            ...
            <div className="container mb-5">
                ...
                <div className="row">
                    ...
                    <div className="col-md-6">
                        <form >
                            <div class="mb-3">
                                <label for="exampleForm" class="form-label">Vaše ime i prezime</label>
                            ...
                            <div class="mb-3">
                                ...
                                <button type="submit" class="btn btn-outline-primary">Pošalji nam poruku</button>
                        </form>
                    </div>
                    </div>
                </div>
